...
import 'package:TodoX/app/modules/detail/view.dart';
...
class TaskCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        homeCtrl.changeTask(task); //? cause we passed the task along to the details page
        homeCtrl.changeTodos(task.todos ?? []); //? we are also passing the todos to the detail page.
        Get.to(() => DetailPage()); 
      },
      child: Container(
        width: squareWidth / 2,
